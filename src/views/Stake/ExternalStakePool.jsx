...
export default function ExternalStakePool() {
  ...
  return (
    <Zoom in={true}>
      <Paper className={`sgod-card secondary ${isSmallScreen && "mobile"}`}>
          ...
          {!isSmallScreen ? (
            <TableContainer className="stake-table">
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell>
                      <Box className="sgod-pairs">
                        <BondLogo bond={{ bondIconSvg: OhmLusdImg, isLP: true }}></BondLogo>
                        <Typography>SGOD-LUSD</Typography>
                      </Box>
                    </TableCell>
            ...
            <div className="stake-pool">
              <div className={`pool-card-top-row ${isMobileScreen && "small"}`}>
                <Box className="sgod-pairs">
                  <BondLogo bond={{ bondIconSvg: OhmLusdImg, isLP: true }}></BondLogo>
                  <Typography gutterBottom={false}>SGOD-LUSD</Typography>
                </Box>
              </div>
